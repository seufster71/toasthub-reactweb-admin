...
export default function CategoryView({containerState, itemState, appPrefs, onListLimitChange,
	onSearchChange, onSearchClick, onPaginationClick, onOrderBy,
	closeModal, onOption, inputChange, session}) {

	let columns = [];
	if (itemState.prefLabels != null && itemState.prefLabels.ADMIN_CATEGORY_PAGE != null) {
		columns = itemState.prefLabels.ADMIN_CATEGORY_PAGE;
	}
	let group = "TABLE1";
	
	let header = "";
	if (itemState.prefTexts.ADMIN_CATEGORY_PAGE != null && itemState.prefTexts.ADMIN_CATEGORY_PAGE.ADMIN_CATEGORY_PAGE_HEADER != null) {
		header = itemState.prefTexts.ADMIN_CATEGORY_PAGE.ADMIN_CATEGORY_PAGE_HEADER.value;
	}
	  			...
	  			<div className="modal-dialog">
	  				<div className="modal-content">
	  					<div className="modal-header">
	  						...
	  						<h4 className="modal-title">Delete {deleteModalHeader}</h4>
	  					</div>
